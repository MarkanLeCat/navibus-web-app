        ...
        function o(i, f) {
          if (!n[i]) {
            if (!e[i]) {
              ...
              if (!f && c) return c(i, !0);
              if (u) return u(i, !0);
              var a = new Error("No se puede encontrar el módulo '" + i + "'");
                  ...
                  t.exports = (function () {
                    ...
                    var v = (function () {
                      ...
                      return (
                        ...
                        (d.format = function (t) {
                          var n = this;
                          if (!this.isValid()) return "Fecha Inválida";
            ...
            const dataToTable = function (t) {
                ...
                t.data &&
                  ...
                  t.data.forEach((e) => {
                    if (t.headings && t.headings.length !== e.length)
                      throw new Error(
                        "El número de filas no concuerda con el número de encabezados."
                      );
              ...
              defaultConfig = {
                ...
                labels: {
                  ...
                  info: "Mostrando de {start} a {end} de {rows} resultados",
                },
            ...
            class DataTable {
              ...
              render(t) {
                ...
                if (
                  ...
                  (t += e.labels.perPage),
                    (t += "<label>resultados por página</label></div>");
