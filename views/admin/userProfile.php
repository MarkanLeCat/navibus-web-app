            ...
            <main id="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="../assets/img/faces/default.png" width="160" height="160">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label form-label" for="username"><strong>Nombre de Usuario</strong></label>
                                                    <div class="form-group position-relative has-icon-left"><input class="form-control form-control" type="text" id="username" name="username" autocomplete="off" value="Nombre de Usuario" required="">
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        <div class="mb-3"><label class="form-label" for="current-password"><strong>Contraseña Actual</strong></label>
                                            <div class="form-group position-relative has-icon-left"><input class="form-control" type="password" id="current-password" name="current-password" placeholder="Contraseña Actual" required="" minlength="8" title="La contraseña debe tener al menos 8 caracteres, 1 minúscula, 1 mayúsculas y 1 símbolo." autocomplete="off">
                                        ...
                                        <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit">Cambiar Contraseña</button></div>
                                    </form>
                                </div>
                            </div>
                        </div>
