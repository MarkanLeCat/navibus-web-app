                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="list-group lapse-list">
                                            <?php foreach ($lapses as $lapse) { ?>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        foreach($lapseTasks as $task) { ?>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <button class="btn btn-info btn-sm edit-task-button" type="button" data-bs-target="#taskInfo-<?php echo $task->getTaskId(); ?>" data-bs-toggle="modal" data-bs-dismiss="modal">
                                                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-eye-fill float-end">
                                                                                                            <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"></path>
                                                                                                            <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"></path>
                                                                                                        </svg>
                                                ...
                                                <!-- Foreach para los modales de visualizar tareas -->
                                                <?php 
                                                $lapseTasks = $tasks->getAllTasksByLapseId($lapse->getLapseId());
                                                    ...
                                                    <div class="modal fade text-left" role="dialog" tabindex="-1" id="taskInfo-<?php echo $task->getTaskId(); ?>" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <!-- Header del Modal -->
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="myModalLabel-4"><?php echo $task->getTaskTitle(); ?></h5><button type="button" class="close rounded-pill" data-bs-dismiss="modal" aria-label="Close"><i data-feather="x"></i></button><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                    ...
                                                                    <div class="container-fluid">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 modal-task_description">
                                                                                <h6>Descripción</h6>
                                                                                <p><?php echo $task->getTaskDescription(); ?></p>
                                                                            </div>
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <table class="table mb-0">
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>Lapso:</td>
                                                                                                <td><?php echo $task->getTaskLapse(); ?></td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td>Duración estimada:</td>
                                                                                                <td><?php echo $task->getTaskHours(); ?> horas</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td>Embarcación:</td>
                                                                                                <td><?php echo $task->getTaskShip(); ?></td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td>Fecha de creación:</td>
                                                                                                <td><?php echo $task->getTaskCreatedAt(); ?></td>
