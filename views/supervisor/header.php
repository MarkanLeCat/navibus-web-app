      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="dropdown" id="dropdown-profile">
          <a class="dropdown-toggle d-flex" aria-expanded="false" data-bs-toggle="dropdown" href="#">
            <div class="user-menu d-flex">
              ...
              <div class="user-img d-flex align-items-center">
                <div class="avatar avatar-md"><img src="<?php echo constant('URL'); ?>assets/img/faces/default.png"></div>
              </div>
            </div>
          </a>
          <!-- Opciones del Perfil -->
          <div class="dropdown-menu dropdown-menu-end">
            ...
            <!-- Enlace al Perfil -->
            <a class="dropdown-item" href="<?php echo constant('URL'); ?>supervisor/profile"><i class="icon-mid bi bi-person me-2"></i>Mi perfil</a>
