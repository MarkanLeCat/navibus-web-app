...
<head>
    ...
    <title>Estadísticas generales - Navibus</title>
            ...
            <main id="main-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 order-first order-md-2">
                                <nav class="float-start float-md-end breadcrumb-header" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active" aria-current="page"><span>Estadísticas generales</span></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="row">
                    <!-- <div class="new-task">
                        <div class="row">
                            <div class="col">
                                <a class="btn btn-danger export-pdf" role="button" target="_blank">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Tareas totales asignadas en el sistema:</td>
                                                        <td><?php echo $stats->countAllTasks()['Total']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Horas totales trabajadas:</td>
                                                        <td><?php echo $stats->sumAllHours()['Total']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Tareas totales "Por hacer":</td>
                                                        <td><?php echo $stats->countAllTasksToDo()['Total']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Tareas totales "En curso":</td>
                                                        <td><?php echo $stats->countAllTasksInProgress()['Total']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Tareas totales "Finalizadas":</td>
                                                        <td><?php echo $stats->countAllTasksFinished()['Total']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Tareas totales "Aprobadas":</td>
                                                        <td><?php echo $stats->countAllTasksApproved()['Total']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Usuarios totales en el sistema</td>
                                                        <td><?php echo $stats->countAllUsers()['Total']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Usuarios "Supervisor" totales en el sistema</td>
                                                        <td><?php echo $stats->countAllSupervisors()['Total']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Usuarios "Operador" totales en el sistema</td>
                                                        <td><?php echo $stats->countAllOperators()['Total']; ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
