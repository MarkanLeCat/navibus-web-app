                ...
                <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 order-first order-md-2">
                                    <nav class="float-start float-md-end breadcrumb-header" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?php echo constant('URL'); ?>"><span>Estadísticas generales</span></a></li>
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow card-user-image">
                                    <img class="rounded-circle mb-3 mt-4" src="<?php echo constant('URL'); ?>assets/img/faces/default-administrative.png" width="160" height="160">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <form action="<?php echo constant('URL'); ?>administrative/updateUserData" method="POST">
                                    <div class="row">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo constant('URL'); ?>administrative/updateUserPassword" method="POST">
