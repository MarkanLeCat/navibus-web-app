                            ...
                            <div class="dropdown" id="dropdown-profile"><a class="dropdown-toggle d-flex" aria-expanded="false" data-bs-toggle="dropdown" href="#">
                                    <div class="user-menu d-flex">
                                        ...
                                        <div class="user-img d-flex align-items-center">
                                            <div class="avatar avatar-md"><img src="../assets/img/faces/default-administrative.png"></div>
                                        </div>
                                    </div>
                                </a>
            ...
            <main id="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="../assets/img/faces/default-administrative.png" width="160" height="160">
