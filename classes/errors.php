...
class Errors{
    ...
    const ERROR_ADMIN_USERPROFILE_NOTFOUND       = "fhs9i48i09yhi493yrei837i9rt948447";
    ...
    const ERROR_ADMIN_NEWUSER_USERNAMELENGTH      = "a5bc437g453fferrftewy8758947ed";
    const ERROR_ADMIN_NEWUSER_EMAILLENGTH      = "folvnhi8274nhsofg73lksb26126348";
    const ERROR_ADMIN_NEWUSER_NAMELENGTH          = "293873493ufnjr983uy485rher83yg";
    const ERROR_ADMIN_NEWUSER_LASTNAMELENGTH      = "2928rjfjfiurtytui23s4585gfkbfd";
    const ERROR_ADMIN_NEWUSER_PHONELENGTH         = "1465153fsdfsd51g5r1g5ds3f1gd53gr";
    const ERROR_ADMIN_NEWUSER_POSITIONLENGTH         = "028h8569kfgiktghdtsycicpobg8367y";
    ...
    const ERROR_SUPERVISOR_CREATELAPSE_EMPTY          = "eehf74og8ea9a7dyw34iu549rfye384f";
    const ERROR_SUPERVISOR_CREATELAPSE_NAMETOOLONG   = "ehdd3qr43tr4565hy656536rw38f7f5f";
    const ERROR_SUPERVISOR_CREATELAPSE_INITIALDATE   = "ehd894kj68g6qw9rftg5y55482528f7f5f";
    const ERROR_SUPERVISOR_CREATELAPSE_ENDDATE   = "ehrf74ityjf8185rgtgh7565218f7f5f";
    const ERROR_SUPERVISOR_CREATELAPSE_DATEPERIOD   = "e7f9i4jnrt8r6y483492789gh8grjew76432";
    const ERROR_SUPERVISOR_CREATELAPSE_OVERLAP   = "e7f9fjhe8745hj5689tu454r6y38rty4832";
    const ERROR_SUPERVISOR_UPDATELAPSE               = "266c43aef9319533f68d6f0ce16cbb5f";
    const ERROR_SUPERVISOR_UPDATELAPSE_EMPTY          = "eehfd7r459tyu849fhe93er549rfye384f";
    const ERROR_SUPERVISOR_UPDATELAPSE_NAMETOOLONG   = "ehdd3d7r94y4rr74ir5u844r48f7f5f";
    const ERROR_SUPERVISOR_UPDATELAPSE_INITIALDATE   = "ehd89d7r94yfr84ith84h528f7f5f";
    const ERROR_SUPERVISOR_UPDATELAPSE_ENDDATE   = "ehrf74ityr834iutr8ru48i444er8f7f5f";
    const ERROR_SUPERVISOR_UPDATELAPSE_DATEPERIOD   = "e7f9i4d7r38r5749rtjuruj48grjew76432";
    const ERROR_SUPERVISOR_UPDATELAPSE_OVERLAP   = "e7f9fjher84957jjrtu3er38rty4832";
    ...
    public function __construct()
    {
        $this->errorsList = [
            ...
            Errors::ERROR_ADMIN_USERPROFILE_NOTFOUND => 'No se encontró el usuario',
            ...
            Errors::ERROR_ADMIN_NEWUSER_USERNAMELENGTH => 'El nombre de usuario superó el límite de caracteres',
            Errors::ERROR_ADMIN_NEWUSER_EMAILLENGTH => 'El correo electrónico superó el límite de caracteres',
            Errors::ERROR_ADMIN_NEWUSER_NAMELENGTH  => 'El nombre superó el límite de caracteres',
            Errors::ERROR_ADMIN_NEWUSER_LASTNAMELENGTH => 'El apellido superó el límite de caracteres',
            Errors::ERROR_ADMIN_NEWUSER_POSITIONLENGTH  => 'El cargo superó el límite de caracteres',
            Errors::ERROR_ADMIN_NEWUSER_PHONELENGTH  => 'El número de teléfono superó el límite de caracteres',
            ...
            Errors::ERROR_SUPERVISOR_CREATELAPSE_EMPTY     => 'Uno o más campos estaban vacíos',
            Errors::ERROR_SUPERVISOR_CREATELAPSE_NAMETOOLONG  => 'El nombre sobrepasa el límite de caracteres',
            Errors::ERROR_SUPERVISOR_CREATELAPSE_INITIALDATE  => 'La fecha inicial no puede ser anterior a la actual',
            Errors::ERROR_SUPERVISOR_CREATELAPSE_ENDDATE  => 'La fecha final no puede ser anterior a la inicial',
            Errors::ERROR_SUPERVISOR_CREATELAPSE_DATEPERIOD  => 'El período de tiempo entre el inicio y el final no concuerda con la categoría',
            Errors::ERROR_SUPERVISOR_CREATELAPSE_OVERLAP  => 'El lapso se solapa con otro lapso de la misma categoría',
            Errors::ERROR_SUPERVISOR_UPDATELAPSE          => 'Hubo un error al intentar actualizar el lapso',
            Errors::ERROR_SUPERVISOR_UPDATELAPSE_EMPTY     => 'Uno o más campos estaban vacíos',
            Errors::ERROR_SUPERVISOR_UPDATELAPSE_NAMETOOLONG  => 'El nombre sobrepasa el límite de caracteres',
            Errors::ERROR_SUPERVISOR_UPDATELAPSE_INITIALDATE  => 'La fecha inicial no puede ser anterior a la actual',
            Errors::ERROR_SUPERVISOR_UPDATELAPSE_ENDDATE  => 'La fecha final no puede ser anterior a la inicial',
            Errors::ERROR_SUPERVISOR_UPDATELAPSE_DATEPERIOD  => 'El período de tiempo entre el inicio y el final no concuerda con la categoría',
            Errors::ERROR_SUPERVISOR_UPDATELAPSE_OVERLAP  => 'El lapso se solapa con otro lapso de la misma categoría',
